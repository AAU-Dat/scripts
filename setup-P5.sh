...
{
LIST_OF_PACKAGES="build-essential gdb unzip bat python3-pygments python-is-python3 python3 python3-pip ipython3 postgresql postgresql-contrib texlive-full"
...
pip install -U pip
pip install -U matplotlib jupyterlab
